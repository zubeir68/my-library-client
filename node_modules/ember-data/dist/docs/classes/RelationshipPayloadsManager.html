...
<head>
    <meta charset="utf-8">
    <title>RelationshipPayloadsManager - The ember-data API</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>RelationshipPayloadsManager Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/addon_-private_system_relationships_relationship-payloads-manager.js.html#l6"><code>addon&#x2F;-private&#x2F;system&#x2F;relationships&#x2F;relationship-payloads-manager.js:6</code></a>
        </div>
...
<div class="box intro">
    <p>Manages relationship payloads for a given store, for uninitialized
...
<div id="method_" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_relationships_relationship-payloads-manager.js.html#l67"><code>addon&#x2F;-private&#x2F;system&#x2F;relationships&#x2F;relationship-payloads-manager.js:67</code></a>
        </p>
    ...
    <div class="description">
        <p>Find the payload for the given relationship of the given model.</p>
...
the payload of the inverse relationship.</p>
        ...
        <div class="example">
            ...
            <div class="example-content">
                <p>relationshipPayloadsManager.get('hobby', 2, 'user') === {
{
data: {
id: 1,
type: 'user'
...
<div id="method_" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_relationships_relationship-payloads-manager.js.html#l91"><code>addon&#x2F;-private&#x2F;system&#x2F;relationships&#x2F;relationship-payloads-manager.js:91</code></a>
        </p>
    ...
    <div class="description">
        <p>Push a model's relationships payload into this cache.</p>
...
relationshipPayloadsManager.push('user', 1, userPayload.data.relationships);</p>
...
<div id="method_" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_relationships_relationship-payloads-manager.js.html#l127"><code>addon&#x2F;-private&#x2F;system&#x2F;relationships&#x2F;relationship-payloads-manager.js:127</code></a>
        </p>
    ...
    <div class="description">
        <p>Unload a model's relationships payload.</p>
...
<div id="method_" class="method item private">
    <h3 class="name"><code></code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_relationships_relationship-payloads-manager.js.html#l143"><code>addon&#x2F;-private&#x2F;system&#x2F;relationships&#x2F;relationship-payloads-manager.js:143</code></a>
        </p>
    ...
    <div class="description">
        <p>Find the RelationshipPayloads object for the given relationship.  The same
...
<p>relationshipPayloads.get('user', 'hobbies') === relationshipPayloads.get('hobby', 'user');</p>
<p>The signature has a somewhat large arity to avoid extra work, such as
a)  string manipulation &amp; allocation with <code>modelName</code> and
<code>relationshipName</code>
b)  repeatedly getting <code>relationshipsByName</code> via <code>Ember.get</code></p>
...
<div id="method_" class="method item private">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/addon_-private_system_relationships_relationship-payloads-manager.js.html#l312"><code>addon&#x2F;-private&#x2F;system&#x2F;relationships&#x2F;relationship-payloads-manager.js:312</code></a>
        </p>
    ...
    <div class="description">
        <p>Create the <code>RelationshipsPayload</code> for the relationship <code>modelName</code>, <code>relationshipName</code>, and its inverse.</p>
