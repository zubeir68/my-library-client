define('client/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('client/templates/book.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/book.hbs should pass TemplateLint.\n\nclient/templates/book.hbs\n  2:4  error  Incorrect indentation for `<h1>` beginning at L2:C4. Expected `<h1>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:4  error  Incorrect indentation for `<br>` beginning at L3:C4. Expected `<br>` to be at an indentation of 2 but was found at 4.  block-indentation\n  4:4  error  Incorrect indentation for `<h1>` beginning at L4:C4. Expected `<h1>` to be at an indentation of 2 but was found at 4.  block-indentation\n  5:4  error  Incorrect indentation for `<br>` beginning at L5:C4. Expected `<br>` to be at an indentation of 2 but was found at 4.  block-indentation\n');
  });
